        ...
        <div class="container containere-what-service containere-what-service-smm">
            ...
            <div class="what-service-content">
                ...
                <span class="what-service-text">Для продвижения бренда используем такие площадки, как
                     ...
                     <a href="#" class="what-service-text-link">Одноклассники</a>
                     <a href="#" class="what-service-text-link">Linkedin</a>
                     <a href="#" class="what-service-text-link">Twitter</a>
...
<section class="why-seo">
    ...
    <div class="container container-why-seo">
        ...
        <div class="why-seo-list">
            ...
            <div class="why-seo-item">
                <h4 class="why-seo-item-title">Прорывной канал для продвижения вашего продукта или услуги</h4>
                <span class="why-seo-item-sub-title">Статистика охвата пользователей в России</span>
                <img src="images/why-seo-img-2.png" class="why-seo-item-img">
            </div>
        </div>
    </div>
</section>
<section class="how-affect how-affect-smm">
        ...
        <div class="wrapper-affect">
            <div class="bad-affect">
                ...
                <ul class="bad-affect-list">
                    ...
                    <li class="bad-affect-item"><p>Уровень лояльности аудитории бренда</p><img src="images/branding-diagramm-1.png"></li>
                </ul>
            </div>
            <div class="good-affect">
                ...
                <ul class="good-affect-list">
                    ...
                    <li class="good-affect-item"><p>Обратная связь от клиентов</p><img src="images/branding-diagramm-3.png"></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <ul class="dev-stage-list dev-stage-list-seo">
            <li class="dev-stage-items dev-stage-items-smm"><span class="number-dev-stage">1</span><p class="dev-stage-text">Технический анализ</p>
                <span class="dev-stage-item-text">повысить рост лояльности текущих и потенциальных клиентов
                    ...
                    провести анализ обратной связи от пользователей
...
<section class="pack-price">
    ...
    <div class="container container-pack-price">
        ...
        <div class="pack-item-list">
            <div class="pack-item">
                <h4 class="pack-item-title pack-item-title-smm">SMM-проект “под ключ”</h4>
                <ul class="pack-price-text-list ">
                    <li class="pack-item-text pack-item-smm">Подойдет для узких решений</li>
                    <li class="pack-item-text pack-item-smm">Подойдет для узких решений</li>
                    <li class="pack-item-text pack-item-smm">Подойдет для узких решений</li>
                    <li class="pack-item-text pack-item-smm">Подойдет для узких решений</li>
                    <li class="pack-item-text pack-item-smm">Подойдет для узких решений</li>
            ...
            <div class="pack-item">
                <h4 class="pack-item-title pack-item-title-smm">Таргетированнаая реклама </h4>
                <ul class="pack-price-text-list">
                        <li class="pack-item-text pack-item-smm">Подойдет для узких решений</li>
                        <li class="pack-item-text pack-item-smm">Подойдет для узких решений</li>
                        <li class="pack-item-text pack-item-smm">Подойдет для узких решений</li>
            ...
            <div class="pack-item">
                <h4 class="pack-item-title pack-item-title-smm">Ведение контента</h4>
                <ul class="pack-price-text-list">
                        <li class="pack-item-text pack-item-smm">Подойдет для узких решений</li>
                        <li class="pack-item-text pack-item-smm">Подойдет для узких решений</li>
                        <li class="pack-item-text pack-item-smm">Подойдет для узких решений</li>
