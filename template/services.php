<div class="container">
    ...
    <div class="services-list">
        <div class="services-list__item">
            ...
            <a href="service-2.php" class="services-list__item-link">Подробнее</a>
        </div>
        <div class="services-list__item">
            <div class="wrapper-item-top">
            ...
            <ul class="services-sub">
                <li class="services-sub__item">
                    <a href="web-site.php" class="services-sub__item-link">Landing-page</a>
                </li>
                <li class="services-sub__item">
                    <a href="web-site.php" class="services-sub__item-link">Сайт для бизнеса</a>
                </li>
                <li class="services-sub__item">
                    <a href="web-site.php" class="services-sub__item-link">Интернет-магазин</a>
                </li>
                <li class="services-sub__item">
                    <a href="web-site.php" class="services-sub__item-link">Сложные решения</a>
                </li>
            </ul>
            <a href="web-site.php" class="services-list__item-link">Подробнее</a>
        </div>
        <div class="services-list__item">
            <div class="wrapper-item-top">
            ...
            <ul class="services-sub">
                <li class="services-sub__item">
                    <a href="seo.php" class="services-sub__item-link">SEO</a>
                </li>
                <li class="services-sub__item">
                    <a href="service-context.php" class="services-sub__item-link">Контекстная реклама</a>
                </li>
                <li class="services-sub__item">
                    <a href="smm.php" class="services-sub__item-link">SMM</a>
                </li>
                <!-- <li class="services-sub__item">
            ...
            <a href="outside.php    " class="services-list__item-link">Подробнее</a>
        </div>
        <div class="services-list__item">
            <div class="wrapper-item-top">
        ...
        <div class="services-list__item">
            <div class="wrapper-item-top">
                <h3 class="services-list__item-title">Автоматизация</h3>
