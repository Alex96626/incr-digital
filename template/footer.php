<div class="container">
    ...
    <nav class="footer-nav">
        <ul class="footer-nav-list">
            ...
            <li class="footer-nav-list__item">
                <a href="service.php" class="footer-nav-list__item-link">Услуги</a>
            </li>
            <li class="footer-nav-list__item">
                <a href="about_us.php" class="footer-nav-list__item-link">Агенство</a>
            </li>
            <li class="footer-nav-list__item">
                <a href="blog.php" class="footer-nav-list__item-link">Блог</a>
            </li>
            <li class="footer-nav-list__item">
                <a href="contact.php" class="footer-nav-list__item-link">Контакты</a>
            </li>
        </ul>
    </nav>
